...
const tools: Tool[] = [
  { name: "Nepal Calendar", desc: "Multi-calendar system with festivals & events", href: "/calendar" },
  { name: "Tax Calculator", desc: "Nepal tax calculation and planning tools", href: "/tax-calculator" },
  { name: "Finance Tools", desc: "NEPSE, forex, and market analysis", href: "/finance" },
  { name: "Weather Portal", desc: "Weather forecasts for Nepal cities", href: "/weather" },
  { name: "Unicode Converter", desc: "Nepali text conversion tools", href: "/tools" },
  { name: "Nepal Explorer", desc: "Discover Nepal's culture and facts", href: "/explore" },
];
  ...
  <section id="tools" className="py-32 px-6 border-t border-border">
    <div className="max-w-7xl mx-auto">
      ...
      <p className="text-muted-foreground max-w-2xl mb-16">
        A collection of tools and services built for the Nepalese community.
      </p>
